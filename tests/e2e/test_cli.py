...
def test_cli__when_output_gtfs_zip_exists_and_overwrite_flag_not_set__fails_and_displays_error_message(gtfs_nyc: str,
    ...
    output = subprocess.run([CLI_PATH, gtfs_nyc, existing_output_gtfs, *route_ids], capture_output=True, text=True)
...
def test_cli__when_output_gtfs_zip_exists_and_overwrite_flag_set__is_successful(gtfs_nyc: str,
                                                                                existing_output_gtfs: str,
    ...
    output = subprocess.run([CLI_PATH, overwrite_opt, gtfs_nyc, existing_output_gtfs, *route_ids], capture_output=True,
                            text=True)
